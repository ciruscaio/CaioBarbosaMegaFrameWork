...
namespace Conexao
{
    ...
    /// Banco de Dados
    /// </summary>
    public class DBConexao_SQLServer
    {
        /// <summary>
        ...
        {
            return DataBaseLocator_SQLServer.getInstance().GetConnection();
        }
        ...
        ///     </code>
        /// </example>
        protected SqlDataReader returnDataReader(SqlCommand pSqlCommand)
        {
            SqlConnection lSqlConnection = null;
            SqlDataReader lSqlDataReader = null;

            try
            {
                lSqlConnection = obterConexao();

                pSqlCommand.Connection = lSqlConnection;

                lSqlConnection.Open();
                lSqlDataReader = pSqlCommand.ExecuteReader();
        ...
        ///     </code>
        /// </example>
        protected DataTable returnDataTable(SqlCommand pSqlCommand)
        {
            SqlConnection lSqlConnection = null;
            ...
            try
            {
                lSqlConnection = obterConexao();
                pSqlCommand.Connection = lSqlConnection;
                SqlDataAdapter lSqlDataAdapter = new SqlDataAdapter(pSqlCommand);
        ...
        ///     </code>
        /// </example>
        protected void executeNonQuery(SqlCommand pSqlCommand)
        {
            SqlConnection lSqlConnection = null;
        ...
        ///     Caso dê algum erro levantará uma exceção com a descrição do mesmo.
        /// </param>
        protected object executeScalar(SqlCommand pSqlCommand)
        {
            ...
            try
            {
                ...
                pSqlCommand.Connection = lConnection;
