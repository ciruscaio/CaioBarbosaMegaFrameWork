...
namespace Conexao
{
    ...
    /// Banco de Dados
    /// </summary>
    public class DBConexao_PostGres
    {
        /// <summary>
        ...
        {
            return DataBaseLocator_PostGres.getInstance().GetConnection();
        }
        ...
        /// </returns>    
        protected DataTable returnDataTable(NpgsqlCommand pNpgsqlCommand)
        {
            NpgsqlConnection lNpgsqlConnection = null;

            try
            {
                lNpgsqlConnection = obterConexao();
                pNpgsqlCommand.Connection = lNpgsqlConnection;
                NpgsqlDataAdapter lNpgsqlDataAdapter = new NpgsqlDataAdapter(pNpgsqlCommand);

                lNpgsqlConnection.Open();
                DataTable lDataTable = new DataTable();
                lNpgsqlDataAdapter.Fill(lDataTable);
            ...
            {
                if (lNpgsqlConnection != null)
                {
                    lNpgsqlConnection.Close();
                }
            }
        }
        ...
        /// </param>
        protected int executeNonQuery(NpgsqlCommand pNpgsqlCommand)
        {
            NpgsqlConnection lNpgsqlConnection = null;            
            ...
            try
            {
                ...
                lNpgsqlConnection.Open();
                return pNpgsqlCommand.ExecuteNonQuery();
            }
        ...
        ///     Caso dê algum erro levantará uma exceção com a descrição do mesmo.
        /// </param>
        protected object executeScalar(NpgsqlCommand pNpgsqlCommand)
        {
            NpgsqlConnection lNpgsqlConnection = null;
            ...
            try
            {
                ...
                lNpgsqlConnection.Open();
                return pNpgsqlCommand.ExecuteScalar();
            }
