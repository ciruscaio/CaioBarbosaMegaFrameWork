...
{
    /// <summary>
    /// Esta classe tem como finalidade gerar e validar código de barras.
    /// </summary>
    public class CodigoBarras_EAN13
    {
        #region PROPIEDADES
        ...
        public static CodigoBarras_EAN13 ObterCodigoBarras_EAN13()
        {
            return new CodigoBarras_EAN13();
        }

        public CodigoBarras_EAN13()
        {

        }

        public CodigoBarras_EAN13(string mfgNumber, string productId)
        {
            this.CountryCode = "00";
        ...
        public CodigoBarras_EAN13(string countryCode, string mfgNumber, string productId)
        {
        ...
        public CodigoBarras_EAN13(string countryCode, string mfgNumber, string productId, string checkDigit)
        {
            this.CountryCode = countryCode;
            this.ManufacturerCode = mfgNumber;
            this.ProductCode = productId;
